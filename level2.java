...
public class level2 extends World
{
    ...
    private void prepare(int lifesOfPlayer, int score)
    {
        ...
        Brick10.setLocation(187,457);
        Brick10.setLocation(180,465);
        Brick Brick30 = new Brick();
        addObject(Brick30,115,519);
        Brick Brick31 = new Brick();
        addObject(Brick31,382,376);
        Brick Brick32 = new Brick();
        addObject(Brick32,345,553);
        Brick Brick33 = new Brick();
        addObject(Brick33,426,219);
        Bomb bomb4 = new Bomb();
